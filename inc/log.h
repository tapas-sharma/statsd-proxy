...
#define log(level,msg,...)						\
  do									\
    {									\
      configuration.log_file?fprintf(configuration.log_file,"%s (%s, %d) "msg"\n",LEVEL_TO_STRING(level),__FUNCTION__, __LINE__,##__VA_ARGS__):printf("(%s,%d)LOG FILE NOT INITIALIZED\n", __FUNCTION__, __LINE__); \
